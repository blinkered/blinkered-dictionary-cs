# Blinkered dictionary: Czech

The Czech word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Czech.

**21,486 of 22,001 candidates proved — 97.7%**, across 7 independent
families, 5 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Czech, and why those
...
Candidates come from Blinkered's Czech list, which lives in
[`blinkered-attestation/candidates/cs`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/cs).
